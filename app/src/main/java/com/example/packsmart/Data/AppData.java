package com.example.packsmart.Data;

import android.app.Application;
import android.content.Context;
import android.widget.Toast;

import com.example.packsmart.Constants.MyConstants;
import com.example.packsmart.Database.RoomDB;
import com.example.packsmart.Models.Items;
...
public class AppData extends Application {
    ...
    public List<Items> getBasicData() {
        ...
        basicItem.add(new Items("Eye Pitch", category, false));
    ...
    public List<Items> getPersonalCareData()
    {
        String[] data = {"Tooth-brush", "Tooth-paste", "Floss", "Mouthwash", "Shaving Cream", "Razor Blade", "Soap", "Fiber",
                ...
                "Moisturizer", "Lip Cream", "Contact Lens", "Perfume", "Deodorant", "Makeup Materials", "Makeup Remover",
    ...
    {
        String[] data = {"Stockings", "Underwear", "Pajamas", "T-Shirts", "Casual Dress", "Evening Dress", "Shirt", "Cardigan",
                "Vest", "Jacket", "Skirt", "Trousers", "Jeans", "Shorts", "Suit", "Coat", "Rain Coat", "Glove", "Hat", "Scarf",
                "Bikini", "Belt", "Slipper", "Sneakers", "Casual Shoes", "Heeled Shoes", "Sports Wear"};
    ...
    public List<Items> getHealthData()
    {
        String[] data = {"Aspirin", "Drugs Used", "Vitamins Used", "Lens Solutions", "Condom", "Hot Water Bag",
                "Tincture Of Lodine", "Adhesive Plaster", "First Aid Kit", "Replacement Lens", "Pain Reliever", "Fever Reducer",
                "Diarrhea Stopper", "Pain Relieve Spray"};
    ...
    public List<Items> getTechnologyData()
    {
        String[] data = {"Mobile Phone", "Phone Cover", "E-Book Reader", "Camera", "Camera Charger", "Portable Speaker",
                "IPad (Tab) ", "Headphone", "Laptop", "Laptop Charger", "Mouse", "Extension Cable","Data Transfer Cable","Battery"
                , "Power Bank", "DVD Player", "Flash-Light", "MP3 Player", "MP3 Player Charger", "Voltage Adapter", "SD Card"};
    ...
    {
        String[] data = {"Sea Glasses", "Sea Bed", "Suntan Cream", "Beach Umbrella", "Beach Bag", "Beach Towel", "Beach Slippers",
    ...
    String[] data = {"Pump", "Car Jack", "Spare Car Key", "Accident Record", "Car Cover", "Car Charger", "Window Sun Shades"};
