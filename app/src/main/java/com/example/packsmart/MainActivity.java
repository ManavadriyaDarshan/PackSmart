...
import com.example.packsmart.Adapter.Adapter;
import com.example.packsmart.Constants.MyConstants;
import com.example.packsmart.Data.AppData;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void persistAppData()
    {
        ...
        if(!prefs.getBoolean(MyConstants.FOOD_CAMEL_CASE, false))
        {
            appData.persistAllDate();
